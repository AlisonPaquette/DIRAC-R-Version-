...
#load("~/DATA/1021PTVST.Rdata")
load("~/DATA/282015Option4forDIRAC.RData")
TindexDir<-DATA[2,]
TindexDir[TindexDir=="Y"]<- 0 #Change this to your REF variable of Interest
TindexDir[TindexDir=="N"]<-1 #Change this to your CASE variable of Interest



TindexDir<-DATA[2,]
TindexDir[TindexDir=="T"]<- 0 #Change this to your REF variable of Interest
TindexDir[TindexDir=="PT"]<-1 #Ch
...
save(CVaccuracy,file="crossvalkeggoption3.RData")
set.seed(32)#random number
...
save(storeResultsT,file="~/Results/PTBReactome1182016.Rdata")
