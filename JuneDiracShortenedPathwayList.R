library(RCurl)
eval( expr =
        parse( text = getURL("https://bioconductor.org/biocLite.R",
...
load("~/DATA/282015Option3forDIRAC.RData")
DATA<-read.csv("~/Documents/Project 1. Preterm Birth/BillAckerman/552016DiracMatrix.csv")
#DATA<-read.csv("~/DATA/552016DiracMatrix.csv")
TindexDir<-DATA[1,]
Texpr.data<-DATA[-1,]
...
save(CVaccuracy,file="crossvalkegg627.RData")
...
save(storeResultsT,file="6232016DIRACKEGG.Rdata")
